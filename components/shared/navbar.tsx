...
export default function Navbar() {
    ...
    return (
        <div className=" fixed xl:w-full md:w-full sm:w-full flex justify-center items-center w-auto h-20 z-[100]">
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div>
                    <ul className='flex xl:hidden md:hidden sm:hidden'>
                ...
                <div>
                    <ul className='xl:flex md:flex sm:flex hidden justify-between items-center gap-8'>

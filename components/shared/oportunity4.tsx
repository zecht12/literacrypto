...
export default function Oportunity4() {
    return (
        <div className="w-full nd:h-screen h-[95vh] md:bg-image9 bg-image10 bg-center bg-cover mx-auto xl:px-16 md:px-12 sm:px-8 px-6 xl:pt-24 md:pt-16 sm:pt-16 pt-12 md:flex flex-none md:justify-start justify-center items-center">
